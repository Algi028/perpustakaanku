...
<body class="nav-md">
    ...
    <!-- JQVMap -->
    <script src="<?= base_url('public/gt/')?>vendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="<?= base_url('public/gt/')?>vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="<?= base_url('public/gt/')?>vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
